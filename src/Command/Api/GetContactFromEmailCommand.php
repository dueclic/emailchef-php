...
class GetContactFromEmailCommand
{
    ...
    public function execute($listId, $email, $headers)
    {
        $response = $this->apiService->call('get', '/apps/api/v1/contacts?limit=1000&list_id=' . $listId . '&query_string=' . urlencode($email), null, $headers);
