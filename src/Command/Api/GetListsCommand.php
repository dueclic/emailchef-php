...
class GetListsCommand
{
    ...
    public function execute($headers, $fillGroups = true)
    {
        $response = $this->apiService->call('get', '/apps/api/v1/lists?limit=1000', null, $headers);
        if ($response['code'] != '200') {
            ...
            if ($fillGroups) {
                ...
                foreach ($lists as &$list) {
                    $list->groups = $getListSegmentsCommand->execute($list->id, $headers);
